...
void SceneText::Init()
{
	...
	camera.Init(Vector3(0, 0, 0), Vector3(0, 0, 0), Vector3(0, 1, 0));
...
void SceneText::RenderSkybox()
{
	...
	modelStack.Scale(SBSCALE, SBSCALE, SBSCALE);
...
//new code
	...
	RenderText(meshList[GEO_TEXT], "Hello Screen", Color(0, 1, 0));
	modelStack.PopMatrix();
	modelStack.PopMatrix();

	RenderTextOnScreen(meshList[GEO_TEXT], "I am Gungsuh Che font!", Color(1, 1, 0),2,1, 1);
